...
let multiurl;
if(process.env.ENV=="Goog"){multiurl=Google}
else if(process.env.ENV=="Amaz"){multiurl=amazon}
else {
    console.log("please enter correct variable")
    process.exit()
}*/
import fs from 'fs'
...
export const config: WebdriverIO.Config = {
    ...
    suites:{
        Sample:['./features/sample/*.feature']
   ...
   // }
     ...
     */
     afterFeature: async (uri, feature) =>{
         await report.addEnvironment("BROWSER","CHROME")
         await report.addEnvironment("Platform",process.platform)
     },
